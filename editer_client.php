...
$clientInfo = getClientInfoEditerClient($dbh, $client_id);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($nouveau_mot_de_passe)) {
        ...
        $data = [
            ...
            'code_postal' => $code_postal,
            'telephone' => $telephone,
            'mot_de_passe' => $clientInfo['mot_de_passe'], // Réutilisation de l'ancien mot de passe
        ];
    }

    // Appel de la fonction pour mettre à jour les informations du client
    if (miseAJourClientInfo($dbh, $client_id, $data)) {
