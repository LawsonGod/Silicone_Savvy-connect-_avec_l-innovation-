                ...
                <form method="post" class="mb-3">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select id="quantiteStock" name="quantiteStock" class="form-select">
                            ...
                            <option value="inf" <?php echo ($filtreQuantiteStock == 'inf') ? 'selected' : ''; ?>>Inférieur ou égal à 10</option>
                            <option value="sup" <?php echo ($filtreQuantiteStock == 'sup') ? 'selected' : ''; ?>>Supérieur à 10</option>
                        </select>
                    </div>
                    <h4>Catégories</h4>
